...
namespace entrega_cupones.Metodos
{
  class mtdEdades
  {
    ...
    public static List<mdlEdades> GetEdades()// List<mdlMaeFlia> maeflia, int desde, int hasta )
    {
      ...
      using (var context = new lts_sindicatoDataContext())
      {
        ...
        //              select new mdlEdades
        //              {
        //                Edad = mtdFuncUtiles.calcular_edad(flia.MAEFLIA_FECNAC).ToString(),
        //                Mujer = ,
        //                Varon = ,
        //                Cantidad = ,
